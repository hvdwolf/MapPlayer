...
* After first start a (long) initial library scan will take place. If you add new folders/files or remove files/folders, you need to do a rescan.
* Show album art
...
* No repeat options
* No sorting options
* No favorites, no artist or album view, no playlists.
